...
void InvestmentValueForYear(Bank investments[], int numRows, float principal,int Year) {
    ...
    if(updatedValue==0.0) {
        cout<<"No investment data found for the specified year."<<endl;
    } else {
