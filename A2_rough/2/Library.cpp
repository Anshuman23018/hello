...
int main()
{
    ...
    readMagazinesFromFile(items, itemCount, Max_magazines, "D:\\IIITD\\OOPD\\Assignment2\\magazine.csv");

    // Call the function to read journals from a CSV file
    readJournalsFromFile(items, itemCount, Max_journals, "D:\\IIITD\\OOPD\\Assignment2\\journals.csv");
        ...
        case 1:
            ...
            for (int i = 0; i < itemCount; i++)
            {
                if (items[i]->getType() == "magazine")
                {
                    ...
                    string storedTitle = items[i]->title;
